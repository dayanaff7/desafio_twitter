...
class TwittersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create twitter" do
    assert_difference("Twitter.count") do
      post twitters_url, params: { twitter: { avatar: @twitter.avatar, email: @twitter.email, tweet: @twitter.tweet, username: @twitter.username } }
    end
  ...
  test "should update twitter" do
    patch twitter_url(@twitter), params: { twitter: { avatar: @twitter.avatar, email: @twitter.email, tweet: @twitter.tweet, username: @twitter.username } }
